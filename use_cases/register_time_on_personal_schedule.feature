...
When the development worker inputs firm activity in his schedule
...
Then an error message "Development worker is not available for work on the activity" is presented